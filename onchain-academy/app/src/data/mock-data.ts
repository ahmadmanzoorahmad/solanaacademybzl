import type { User, Course, Achievement, Certificate, LeaderboardEntry, NFTAchievement, WalletConnection, CodeChallenge } from '@/types';
...
export const currentUser: User = {
  ...
  skills: { rust: 65, anchor: 50, frontend: 85, security: 40 },
};
...
export const codeChallenge: CodeChallenge = {
  id: 'challenge-1',
