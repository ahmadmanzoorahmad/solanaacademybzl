      ...
      <div className="container px-4 md:px-8 py-12 max-w-[1320px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">Learn. Build. Ship on Solana.</p>
            <div className="flex gap-2">
              ...
              <Button variant="ghost" size="icon" asChild>
                <a href="https://discord.com" target="_blank" rel="noopener noreferrer"><MessageCircle className="w-4 h-4" /></a>
              </Button>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="/courses" className="hover:text-foreground transition-colors">Fundamentals</Link></li>
              <li><Link href="/courses" className="hover:text-foreground transition-colors">DeFi</Link></li>
              <li><Link href="/courses" className="hover:text-foreground transition-colors">Security</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><a href="#" className="hover:text-foreground transition-colors flex items-center gap-1"><Book className="w-3 h-3" /> Documentation</a></li>
        ...
        <div className="mt-8 pt-8 border-t">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-muted-foreground">© 2026 Superteam Solana Academy. Open source and community-driven.</p>
